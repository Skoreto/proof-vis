...
describe('DefinitionPanel', () => {
  ...
  it('should render only the right panel for the currentStep', () => {
    wrapper.setProps({ 
      definitionPanels: [
        {
          id: 1,
          showForSteps: [2],
          content: <p>Fiktivni definice pro krok 2.</p>
        },
        {
          id: 2,
          showForSteps: [4],
    ...
    expect(wrapper.contains(<p>Fiktivni definice pro krok 2.</p>)).toBe(false);
