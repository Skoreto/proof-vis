...
const ExerciseWrapper = (props) => (
    <div className={'container'}>
        <div className='page-wrapper'>
            <PageHeading headingTitle={props.headingTitle} breadcrumbsCurrent={props.breadcrumbsCurrent} />
                        ...
                        <main>
                            {
                                props.isSketchAllowed ? (
                                    <div className={'over-component'}>
                                        <SketchField width='650px' height='400px' 
                                        tool={props.sketchTool} lineColor='#1E88E5' lineWidth={3} />
                                    </div>
                                ) : (<div></div>)
                            }
                            {
                            ...
                            <div className='controls-panel'>
                                ...
                                <span className='sketch-buttons'>
                                    <Button clicked={props.handleSketchAllowance}
                                            active={props.btnSketchA} addClass={props.btnSketchC}>
                                        <FontAwesomeIcon icon={faPaintBrush}/></Button>
                                    <Button clicked={props.handleSketchPencil}
                                            active={props.btnPencilA} disabled={props.btnPencilD}>
                                        <FontAwesomeIcon icon={faPencilAlt}/></Button>
                                    <Button clicked={props.handleSketchLine}
                                            active={props.btnLineA} disabled={props.btnLineD}>
