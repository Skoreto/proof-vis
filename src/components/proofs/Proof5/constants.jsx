...
const claimPanel = (
  <ClaimPanel>
    ...
    <cite>
      <q>
        {" "}
        <MN>\forall G=(V,E)</MN>: Jestliže graf <MN>G</MN> je strom, pak graf{" "}
        <MN>G</MN> je souvislý a každá jeho hrana je most.
      </q>
    </cite>
  </ClaimPanel>
);
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <br />
        <br />
        Přímou metodou tedy budeme dokazovat tvrzení:{" "}
        <cite>
          <q>
            Jestliže graf <MN>G</MN> je nesouvislý nebo existuje hrana{" "}
            <MN>e</MN>, která není most v grafu <MN>G</MN>, pak graf <MN>G</MN>{" "}
            není strom.
          </q>
        </cite>
        <br />
        <br />
        Výrok <MN>\neg B</MN> se navíc skládá ze dvou částí spojených disjunkcí
        (<MN>\vee</MN>), ve větě oddělených slovem <q>nebo</q>:
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        ...
        <cite>
          <q>
            graf <MN>G</MN> je nesouvislý
          </q>
        </cite>
        <br />
        <br />
        Jestliže graf <MN>G</MN> je nesouvislý, pak přímo z definice stromu
        platí, že není strom.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        ...
        <cite>
          <q>
            existuje hrana <MN>e</MN>, která není most v grafu <MN>G</MN>
          </q>
        </cite>
        <br />
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <br />
        <br />
        Jestliže však v grafu <MN>G</MN> existuje hrana <MN>{"e=\\{x,y\\}"}</MN>
        , která <u>není</u> most, pak po jejím odebrání graf <MN>G-e</MN> nebude
        mít více komponent. Vrcholy <MN>x</MN> a <MN>y</MN> se tedy budou
        nacházet stále v jedné souvislé komponentě.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Protože komponenta je sama o sobě souvislý graf. Musí mezi každou
        dvojicí jejích vrcholů existovat cesta.
        <br />
        <br />
        Tudíž v grafu <MN>G-e</MN> musí nadále existovat také cesta{" "}
        <MN>{"P_{xy}"}</MN> mezi vrcholy hrany <MN>{"e=\\{x,y\\}"}</MN>.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Pak ale cesta <MN>{"P_{xy}"}</MN> musela existovat také v grafu{" "}
        <MN>G</MN>, protože graf <MN>G-e</MN> vznikl z grafu <MN>G</MN> pouze
        odebráním hrany <MN>e</MN>.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Z definice kružnice pak vyplývá, že cesta <MN>{"P_{xy}"}</MN> spolu s
        hranou e tvoří kružnici v grafu <MN>G</MN>.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Protože graf <MN>G</MN> obsahuje kružnici, není podle definice stromu
        stromem.
      </p>
    )
  }
...
const descriptionPanels = [
  ...
  },
  {
    ...
    content: (
      <p>
        Příklad nesouvislého grafu <MN>G</MN>, který není strom.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Příklad grafu <MN>G</MN>, kde existuje hrana <MN>{"e=\\{x,y\\}"}</MN>,
        která není most.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Po odebrání hrany <MN>e</MN> zůstanou její vrcholy <MN>x</MN> a{" "}
        <MN>y</MN> stále v jedné souvislé komponentě.
      </p>
    )
  },
  {
    ...
    content: (
      <p>
        Po odebrání hrany <MN>e</MN> v grafu stále existuje také cesta mezi
        jejími vrcholy <MN>x</MN> a <MN>y</MN>.
      </p>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <p>
        Cesta <MN>{"P_{xy}"}</MN> spolu s hranou <MN>e</MN> tvoří kružnici v
        grafu <MN>G</MN>.
      </p>
    )
  }
...
const definitionPanels = [
  {
    ...
    content: (
      <p>
        DEFINICE STROMU (4.2)
        <br />
        Strom je <u>souvislý</u> graf, který neobsahuje kružnici.
      </p>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <div>
        <p>DEFINICE SOUVISLÉHO GRAFU A KOMPONENTY GRAFU (1.9)</p>
        <p>
          <u>Souvislý graf</u> je graf, ve kterém mezi každými jeho dvěma
          vrcholy existuje cesta.
        </p>
        <p>
          <u>Komponenta grafu</u> je každý jeho maximální souvislý podgraf, tj.
          souvislý podgraf, který není podgrafem žádného jiného souvislého
          grafu.
        </p>
      </div>
    )
  ...
  },
  {
    ...
    content: (
      <p>
        DEFINICE STROMU (4.2)
        <br />
        Strom je souvislý graf, který <u>neobsahuje kružnici</u>.
      </p>
    )
  }
];
  ...
  },
  {
    ...
    content: (
      <VisualTextRow left={50} top={190} width={550} classes={"t-red"}>
        <MN>\neg B:</MN> graf <MN>G</MN> je nesouvislý nebo existuje hrana{" "}
    ...
    content: (
      <VisualTextRow left={50} top={310} width={550}>
        ...
        <span className={"t-red"}>
          graf <MN>G</MN> je nesouvislý nebo existuje hrana <MN>e</MN>, která
          není most v grafu <MN>G</MN>
        </span>
        , pak{" "}
        <span className={"t-green"}>
          graf <MN>G</MN> není strom
        </span>
        .
      </VisualTextRow>
    )
