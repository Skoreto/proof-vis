...
const claimPanel = (
  <ClaimPanel>
    Dokažte nepřímo: <cite><q> <MN>\forall G=(V,E)</MN>: Jestliže v grafu <MN>G</MN> neexistuje kružnice, pak každá hrana v grafu <MN>G</MN> je most.</q></cite>
  </ClaimPanel>
);
...
const proofStepPanels = [
  ...
  },
  {
    ...
    content:
      <p>
        Před následující úvahou zvolíme dva libovolné vrcholy <MN>u</MN> a <MN>v</MN>, mezi kterými je možné sestrojit cestu procházející přes hranu <MN>e</MN>. 
        <br />
  ...
  },
  {
    ...
    content:
      <VisualTextRow left={60} top={310} width={550}>
        Jestliže <span className={'t-red'}>existuje hrana v grafu <MN>G</MN>, která není most</span>, pak <span className={'t-green'}>v grafu <MN>G</MN> existuje kružnice</span>.
      </VisualTextRow>
  },
];
