...
class Proof6 extends React.Component {
  ...
  step14 = () => {
    ...
    this.setState({
      timeouts: [
        ...
        setTimeout(() => {
          this.setState(this.step14c);
        }, 3000),
        setTimeout(() => {
          this.setState(this.step14d);
        }, 4000),
        setTimeout(() => {
          this.setState(this.step14e);
        }, 5000),
        setTimeout(() => {
          this.setState(this.step14f);
        }, 6000),
        setTimeout(() => {
          this.setState(this.step14g);
        }, 7000),
        setTimeout(() => {
          this.setState(this.step14h);
        }, 8000),
        setTimeout(() => {
          this.setState(this.step14i);
        }, 9000),
        setTimeout(() => {
          this.setState(this.step14j);
        }, 10000),
        setTimeout(() => {
          this.setState(this.step14k);
        }, 11000),
        setTimeout(() => {
          this.setState(this.step14l);
        }, 12000),
        setTimeout(() => {
          this.setState(this.step14m);
        }, 13000),
        setTimeout(() => {
          this.setState(this.step14n);
        }, 14000),
        setTimeout(() => {
          this.setState(this.step14o);
        }, 15000),
        setTimeout(() => {
          this.setState(this.step14p);
        }, 16000),
        setTimeout(() => {
          this.setState(this.step14q);
        }, 17000),
        setTimeout(() => {
          this.setState(this.step14r);
        }, 18000),
        setTimeout(() => {
          this.setState(this.step14s);
        }, 19000)
      ]
    });
  };
  ...
  step16 = state => {
    return {
      edges: this.updateEdge(state.edges, 5, palette.white, 4, false, "")
    };
  };
