...
const claimPanel = (
  <ClaimPanel>
    Dokažte sporem tvrzení: <cite><q> <MN>\forall G=(V,E):</MN> Jestliže hrana <MN>e</MN> je most v grafu <MN>G</MN>, pak v <MN>G</MN> neexistuje kružnice obsahující hranu <MN>e</MN>.</q></cite>
  </ClaimPanel>
);

const claimPanelEng = (
  <ClaimPanel>
    Prove following statement by contradiction: <cite><q> <MN>\forall G=(V,E):</MN> If an edge <MN>e</MN> is a bridge in a graph <MN>G</MN>, then there does not exist a circle containing the edge <MN>e</MN> in the graph <MN>G</MN>.</q></cite>
  </ClaimPanel>
);
  ...
  },
  {
    ...
    content:
      <p>
        ...
        <br /><br />
        Pro spor tedy předpokládejme tvrzení: <cite><q>Existuje graf <MN>G</MN>, ve kterém hrana <MN>e</MN> je most a zároveň v grafu <MN>G</MN> existuje kružnice obsahující hranu <MN>e</MN>.</q></cite>    
      </p>
  },
  {
...
const proofStepPanelsEng = [
  {
    ...
    content:
      <p>
        While proving by contradiction we start from the negation of the original statement.
        <br /><br />
        The original statement corresponds with the implication <MN>\forall A \Rightarrow B</MN>.
      </p>
  },
  {
    name: 'proofStepPanel2',
  ...
  },
  {
    ...
    content:
      <p>
        ...
        <br /><br />
        Let us assume the following statement for the purpose of contradiction: <cite><q>There is a graph <MN>G</MN> in which the edge <MN>e</MN> is a bridge, and at the same time there exists a circle containing the edge <MN>e</MN> in the graph <MN>G</MN>.</q></cite>  
      </p>
  },
  {
    name: 'proofStepPanel6',
    ...
    content:
      <p>
        If there exists a circle <MN>C</MN> in a graph <MN>G</MN>, which contains the edge <MN>{'e=\\{x,y\\}'}</MN>, then in the graph <MN>G</MN> exists at least 2 <MN>x-y</MN> paths.
      </p>
  },
  {
    name: 'proofStepPanel7',
  ...
  },
  {
    ...
    content:
      <p>
        <b>2.</b> The path <MN>{"P'_{x,y}=C-e=(x,v_1,v_2,...,v_3,y)"}</MN> (the circle without the edge <MN>e</MN>)
      </p>
  },
  {
    name: 'proofStepPanel9',
    ...
    content:
      <p>
        We now show <MN>\forall u,v \in V(G):</MN> if there exists <MN>u-v</MN> path <MN>{"P_{u,v}"}</MN> in the graph <MN>G</MN> <MN>\Rightarrow</MN> then there also exists <MN>u-v</MN> path <MN>{"P'_{u,v}"}</MN> in the graph <MN>G-e</MN>:
        <br /><br />
  ...
  },
  {
    ...
    content:
      <p>
        <b>1.</b> If the path <MN>{"P_{u,v}"}</MN> in the graph <MN>G</MN> does not contain the edge <MN>e</MN>, <MN>{"P'_{u,v}=P_{u,v}"}</MN> applies. In other words, <MN>u-v</MN> path in the graph <MN>G</MN> is the same path as in the graph <MN>G-e</MN>.
      </p>
  },
  {
    name: 'proofStepPanel11',
    ...
    content:
      <p>
        <b>2.</b> If the path <MN>{"P_{u,v}"}</MN> in the graph <MN>G</MN> does not contain the edge <MN>e</MN>, ...
      </p>
  },
  {
    name: 'proofStepPanel12',
    ...
    content:
      <p>
        then we will replace the edge <MN>e</MN> in the alternative path <MN>{"P'_{u,v}"}</MN>  by the path <MN>{"P'_{x,y}"}</MN>. In other words, by the path between vertices <MN>x</MN> and <MN>y</MN> on the circle <MN>C</MN> (see step 10).
        <br /><br />
        By that, a sequence between vertices <MN>u</MN> and <MN>v</MN> in the graph <MN>G-e</MN> will form.
        <br /><br />
        Formally: <MN>{"(P_{u,v} - e) \\cup P'_{x,y} = (P_{u,v} - e) \\cup (C-e)"}</MN>
      </p>
  },
  {
    name: 'proofStepPanel13',
    ...
    content:
      <p>
        <MN>\Rightarrow</MN> Then there exists also a path between the vertices <MN>u</MN> and <MN>v</MN> in the graph <MN>G-e</MN>. (We can omit every part, where we return to the same vertex.)
      </p>
  },
  {
    name: 'proofStepPanel14',
    ...
    content:
      <p>
        <MN>\Rightarrow</MN> Consequently, the number of components of the graph <MN>G-e</MN> is the same as the number of components of the graph <MN>G</MN>.
      </p>
  },
  {
    name: 'proofStepPanel15',
    ...
    content:
      <p>
        <MN>\Rightarrow</MN> According to the definition of a bridge the edge <MN>e</MN> is not a bridge, which is a contradiction with the initial assumption. That is why the original statement applies. <MN>\square</MN>
      </p>
  },
];
...
const descriptionPanelsEng = [
  ...
  },
  {
    id: 2,
    showForSteps: [2],
    content: <p>Atomic statement <MN>A</MN>.</p>
  },
  {
    id: 3,
    showForSteps: [3],
    content: <p>Atomic statement <MN>B</MN>.</p>
  },
  {
    id: 4,
    showForSteps: [5],
    content: <p>The wording of the atomic statement <MN>A</MN> remains the same.</p>
  },
  {
    id: 5,
    showForSteps: [6],
    content: <p>The wording of the negation of the atomic statement <MN>B</MN>.</p>
  },
  {
    id: 6,
    showForSteps: [7],
    content: <p>The complete wording of the negation of the original statement.</p>
  },
  {
    id: 7,
    showForSteps: [8],
    content: 
      <p>
        An example of the graph <MN>G</MN>, where there exists the circle <MN>C</MN>, and select of any edge <MN>e</MN>, which lies on the circle <MN>C</MN>.
      </p>
  },
  {
    id: 8,
    showForSteps: [9],
    content: <p>The path from the vertex <MN>x</MN> to the vertex <MN>y</MN> right across the edge <MN>e</MN>.</p>
  },
  {
    id: 9,
    showForSteps: [10],
    content: <p>The path from the vertex <MN>x</MN> to the vertex <MN>y</MN> across the circle <MN>C</MN>.</p>
  },
  {
    id: 10,
    showForSteps: [11],
    content: <p>Selection of any vertices <MN>u</MN> and <MN>v</MN>.</p>
  },
  {
    id: 11,
    showForSteps: [12],
    content:
      <p>
        The path between the vertices <MN>u</MN> and <MN>v</MN> without the edge <MN>e</MN> is the same in the graph<MN>G-e</MN> as in the graph <MN>G</MN>.
      </p>
  },
  {
    id: 12,
    ...
    content:
      <p>
        Yet, there can exist a path <MN>{"P_{u,v}"}</MN> in the graph <MN>G</MN> which leads across the edge <MN>e</MN>.
      </p>
  },
  {
    id: 13,
    ...
    content: 
      <p>
        We can replace the edge <MN>e</MN> in the graph <MN>G-e</MN> by the path across the circle <MN>C</MN>.
        <br /> By that doing that, the sequence between the vertices <MN>u</MN> and <MN>v</MN> will form.
      </p>
  },
  {
    id: 14,
    ...
    content: 
      <p>
        We will omit the parts between occurrences of the same vertices and the path between the vertices <MN>u</MN> and <MN>v</MN>, which exists also in the graph <MN>G-e</MN> will remain.
      </p>
  },
  {
    id: 15,
    showForSteps: [16],
    content: <p>The count of the components will remain the same after removing the edge <MN>e</MN>.</p>
  },
  {
    id: 16,
    showForSteps: [17],
    content: <p>Because the edge <MN>e</MN>, which lies on the circle, could not be a bridge.</p>
  },
];
    ...
    content:
      <div>
        <p>
          ...
          <br /><MN>\forall G=(V,E)</MN>: If there is a sequence from the vertex <MN>v</MN> to the vertex <MN>w</MN> in the graph <MN>G</MN> <MN>\Rightarrow</MN> then there is a path from the vertex <MN>v</MN> to the vertex <MN>w</MN> in the graph <MN>G</MN>.
        </p>
      </div>
  },
  {
    ...
    content:
      <div>
        <p>
          ...
          <br />Let <MN>G=(V,E)</MN> is a graph, <MN>v \in V</MN> a vertex and <MN>e \in E</MN> an edge.
        </p>
        <p>
          An edge <MN>e</MN> is a bridge in the graph <MN>G</MN>, if the graph <MN>G-e</MN> has more components than the graph <MN>G</MN>.
        </p>
      </div>
  },
];
  ...
  },
  {
    ...
    content:
      <VisualTextRow left={20} top={80} width={610} classes={'t-red'}>
        <MN>B:</MN> there does not exist a circle containing the edge <MN>e</MN> in the graph <MN>G</MN> 
      </VisualTextRow>
  },
  {
    id: 4,
  ...
  },
  {
    ...
    content:
      <VisualTextRow left={20} top={220} classes={'t-red'}>
        <MN>\neg B:</MN> there exists a circle containing the edge <MN>e</MN> in the graph <MN>G</MN>
      </VisualTextRow>
  },
  {
    id: 7,
    ...
    content:
      <VisualTextRow left={20} top={290} width={610}>
        There exists a graph <MN>G</MN>, in which <span className={'t-green'}>the edge <MN>e</MN> is a bridge</span>, and at the same time <span className={'t-red'}>there exists a circle containing the edge <MN>e</MN> in the graph <MN>G</MN></span>.
      </VisualTextRow>
  },
];
