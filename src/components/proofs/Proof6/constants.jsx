...
const claimPanelEng = (
  <ClaimPanel>
    Prove following statement by contradiction: <cite><q> <MN>\forall G=(V,E):</MN> If an edge <MN>e</MN> is a bridge in a graph <MN>G</MN>, then in <MN>G</MN> does not exist a circle containing the edge <MN>e</MN>.</q></cite>
  </ClaimPanel>
);
...
const proofStepPanelsEng = [
  {
    ...
    content:
      <p>
        While proving by contradiction we 
        Při dokazování sporem vycházíme z negace původního tvrzení.
        <br /><br />
        Původní tvrzení odpovídá implikaci ve tvaru <MN>\forall A \Rightarrow B</MN>.
      </p>
...
const descriptionPanelsEng = [
  {
    id: 1,
    showForSteps: [1],
    content: <p>Form of Tvar implikace původního tvrzení.</p>
  },
  {
    id: 2,
    showForSteps: [2],
