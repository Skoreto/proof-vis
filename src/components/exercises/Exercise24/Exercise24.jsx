  ...
  step1SVGContent = () => {
    const svgContent = (
      <svg>
        ...
        <text textAnchor={'middle'} x={142} y={200} fill={'red'} strokeWidth={0} fontSize={26}>
          &not;B: <tspan fontStyle='italic'>G</tspan> není strom
        </text>
        <text textAnchor={'middle'} x={325} y={240} fill={'green'} strokeWidth={0} fontSize={26}>
          &not;A: graf <tspan fontStyle='italic'>G</tspan> je nesouvislý a existuje hrana <tspan fontStyle='italic'>e &isin; E(G)</tspan>
        </text>
        <text textAnchor={'middle'} x={180} y={270} fill={'green'} strokeWidth={0} fontSize={26}>
          která není most
        </text>
        <text textAnchor={'middle'} x={325} y={330} strokeWidth={0} fontSize={26}>
          ...
          <tspan x={325} dy={40} fill={'green'}>a existuje hrana e, která není most v grafu G</tspan>.
        </text>
      </svg>
    );
