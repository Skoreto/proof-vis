...
class Exercise26 extends React.Component {
  ...
  step2 = (state) => {
    ...
    return { graphVis: { nodes: newNodes, edges: newEdges }, description: '' };
  };
                      ...
                      <M.Context input='tex'>
                        <div className="bg-warning" id="proofBox">
                          ...
                          <div className={4 === this.state.currentStep ? ' proof-active' : ''}>
                            <p>
                              <MN>\Rightarrow</MN> v <MN>G-e</MN> neexistuje cesta <MN>u</MN>-<MN>v</MN>
                              <br /><MN>\Rightarrow</MN> vrcholy <MN>u</MN>,<MN>v</MN> se v <MN>G-e</MN> nacházejí v různých komponentách souvislosti
                            </p>
                          </div>
                          <div className={'borderless' +
                            ...
                            <p>
                              ...
                              <br /><MN>\Rightarrow</MN> z definice stromu platí, že <MN>G-e</MN> není strom
                            </p>
